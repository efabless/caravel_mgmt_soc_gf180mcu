...
assign d = bus_dat_w[31:0];
always @(*) begin
	wen = 4'd0;
	wen[0] = (((bus_sel[0] & bus_we) & bus_stb) & bus_cyc);
	wen[1] = (((bus_sel[1] & bus_we) & bus_stb) & bus_cyc);
	wen[2] = (((bus_sel[2] & bus_we) & bus_stb) & bus_cyc);
	wen[3] = (((bus_sel[3] & bus_we) & bus_stb) & bus_cyc);
end
assign bus_dat_r[31:0] = q;
assign cen = 1'd0;
assign gwen = (bus_stb & bus_cyc);
...
GF180_RAM_512x32 GF180_RAM_512x32(
	.A(bus_adr[8:0]),
	.CEN(cen),
	.CLK(sys_clk),
	.D(d),
